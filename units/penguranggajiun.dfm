object penguranggajifrm: Tpenguranggajifrm
  Left = 550
  Top = 118
  ...
  object gridkurang: TDBGrid
    Left = 0
    Top = 53
    Width = 416
    Height = 296
    Align = alClient
    DataSource = ds.penguranggaji
