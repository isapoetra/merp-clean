object projectlapfrm: Tprojectlapfrm
  Left = 404
  Top = 247
  ...
  object Panel2: TPanel
    ...
    object tglawal: TDateTimePicker
      Left = 16
      Top = 78
      Width = 153
      Height = 21
      Date = 40982.540337812500000000
      Time = 40982.540337812500000000
      TabOrder = 0
    end
    object tglakhir: TDateTimePicker
      Left = 200
      Top = 78
      Width = 137
      Height = 21
    ...
    object lookproject: TDBLookupComboBox
      Left = 16
      Top = 24
      Width = 317
      Height = 19
  ...
  object rpjualproject: TRvProject
    Engine = RvSystem1
    Left = 24
    Top = 199
  end
  ...
  object rdjualproject: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = dm.jualrpt
    Left = 112
    Top = 199
  end
  object rdprojectdetailrpt: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = dm.jualdetailrpt
    Left = 144
    Top = 199
  end
  object rdcust: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = dm.jualdetailrpt
    Left = 176
    Top = 199
